...
namespace Public_Bot
{
    ...
    public class SingleGuildIDEntityCache<T> where T : class, IGuildIDEntity
    {
        private Type _type = typeof(T);
        private List<T> _CacheList { get; set; } = new List<T>();
        public T this[ulong Id]
        {
            get => _CacheList.Any(x => x.GuildID == Id)
                ? _CacheList.Find(x => x.GuildID == Id)
                : null;
        ...
        public void Add(T value)
        {
            ...
            if (_CacheList.Any(x => x.GuildID == value.GuildID))
                return;
        ...
        public void Replace(T value)
        {
            ...
            if (_CacheList.Any(x => x.GuildID == value.GuildID))
            {
                ...
                var indx = _CacheList.FindIndex(x => x.GuildID == value.GuildID);
