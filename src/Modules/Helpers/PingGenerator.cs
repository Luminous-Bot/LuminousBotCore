...
namespace Public_Bot
{
    ...
    class PingGenerator
    {
        ...
        public static async Task<Image> Generate(PingData.DiscordApiPing data)
        {
            ...
            ChartGraphics.DrawString($"Discord Ping (Past 24 Hours) Generated on {DateTime.UtcNow.ToString("O")}", TitleFont, new SolidBrush(Color.White), ChartImage.Width / 2, 20, new StringFormat() { Alignment = StringAlignment.Center });
