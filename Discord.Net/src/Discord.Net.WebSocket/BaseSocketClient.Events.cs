...
namespace Discord.WebSocket
{
    public partial class BaseSocketClient
    {
        ...
        internal readonly AsyncEvent<Func<Cacheable<SocketGuildInvite, string>, SocketGuild, Task>> _inviteDeletedEvent = new AsyncEvent<Func<Cacheable<SocketGuildInvite, string>, SocketGuild, Task>>();
        /// <summary> Fired when a invite is deleted. </summary>
        public event Func<Cacheable<SocketGuildInvite, string>, SocketGuild, Task> InviteDeleted
        {
