                                    ...
                                    if(data.GuildID.IsSpecified)
                                    {
                                        ...
                                        if (guild != null)
                                        {
                                            ...
                                            if (channel != null)
                                            {
                                                ...
                                                var cache = new Cacheable<SocketGuildInvite, string>(invite, data.Code, invite != null, async () => await guild.GetSocketInviteAsync(data.Code));
                                                await TimedInvokeAsync<Cacheable<SocketGuildInvite, string>, SocketGuild>(_inviteDeletedEvent, nameof(InviteDeleted), cache, guild).ConfigureAwait(false);
                                            }
                                        }
                                    }
